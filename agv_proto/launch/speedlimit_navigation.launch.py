...
def generate_launch_description():
    ...
    nav2_yaml = os.path.join(get_package_share_directory('agv_proto'), 'config', 'speedlimit_nav2_params.yaml')
    ...
    remappings = [('/cmd_vel_limit', '/diffbot_base_controller/cmd_vel_unstamped')]
